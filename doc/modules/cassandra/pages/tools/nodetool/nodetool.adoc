...
usage: nodetool [(-h <host> | --host <host>)]
        ...
        [(-u <username> | --username <username>)] [(-pp | --print-port)]
...
xref:tools/nodetool/autorepairstatus.adoc[autorepairstatus] -                     Print autorepair status
...
xref:tools/nodetool/getautorepairconfig.adoc[getautorepairconfig] -                  Print autorepair configurations
...
xref:tools/nodetool/setautorepairconfig.adoc[setautorepairconfig] -              
xref:tools/nodetool/sets.adoc[sets] -  the autorepair configuration
...
xref:tools/nodetool/sstablerepairedset.adoc[sstablerepairedset] -                   Set the repaired state of SSTables for given keyspace/tables
